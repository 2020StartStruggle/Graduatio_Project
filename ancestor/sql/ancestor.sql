/*
 ...
 Source Schema         : ancestor

 Target Server Type    : MySQL
 Target Server Version : 50728
 File Encoding         : 65001

 Date: 17/05/2020 21:41:49
*/
...
-- ----------------------------
-- Table structure for ancestor_live
-- ----------------------------
DROP TABLE IF EXISTS `ancestor_live`;
CREATE TABLE `ancestor_live`  (
  `id` int(11) UNSIGNED NOT NULL COMMENT '编号',
  `name` varchar(200) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT NULL COMMENT '地名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = gbk COLLATE = gbk_chinese_ci COMMENT = '居住地' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ancestor_live
-- ----------------------------
INSERT INTO `ancestor_live` VALUES (1, '濠州');
INSERT INTO `ancestor_live` VALUES (2, '北京');

-- ----------------------------
-- Table structure for ancestor_person
-- ----------------------------
DROP TABLE IF EXISTS `ancestor_person`;
CREATE TABLE `ancestor_person`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(50) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT NULL COMMENT '姓名',
  `wife` varchar(100) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT NULL COMMENT '妻子',
  `parent_id` int(11) NULL DEFAULT NULL COMMENT '父编号',
  `level_id` int(11) NULL DEFAULT NULL COMMENT '辈分',
  `live_id` int(11) NULL DEFAULT NULL COMMENT '居住地编号',
  `is_sure` varchar(1) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT '1' COMMENT '确定',
  `remark` varchar(200) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT '' COMMENT '备注',
  `born` varchar(30) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT NULL COMMENT '生于',
  `dead` varchar(30) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT NULL COMMENT '卒于',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 10037 CHARACTER SET = gbk COLLATE = gbk_chinese_ci COMMENT = '家谱' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ancestor_person
-- ----------------------------
INSERT INTO `ancestor_person` VALUES (10000, '朱元璋', '张马', -1, 1, 1, '1', '字国瑞，初名重八，后取名兴宗，参加郭子兴军改为现名朱元璋。中国古代政治家，战略家，军事统帅，明朝开国皇帝。', '1328-10-20T16:00:00.000Z', '1398-06-23T16:00:00.000Z');
INSERT INTO `ancestor_person` VALUES (10036, '朱棣', '', 10000, 2, 1, '1', '', '', '');
INSERT INTO `ancestor_person` VALUES (10034, '朱标', '', 10000, 2, 1, '1', '', '', '');
INSERT INTO `ancestor_person` VALUES (10035, '朱棣', '', NULL, NULL, 2, '1', '', '', '');
...
-- Records of dept
-- ----------------------------
INSERT INTO `dept` VALUES (1, 'ancestor', 0, b'1', '2019-03-25 09:14:05');
...
-- ----------------------------
INSERT INTO `gen_config` VALUES (1, 'zhanghouying', b'1', 'ancestor-system', 'com.ancestor.modules.ancestor.person', 'C:\\work\\ancestor\\ancestor-web\\src\\views\\ancestor\\person', 'C:\\work\\ancestor\\ancestor-web\\src\\api', 'ancestor_');
...
INSERT INTO `menu` VALUES (80, b'0', '家谱管理', 'ancestor/person/index', 81, 999, 'peoples', 'person', b'0', b'0', 'Person', '2019-11-18 23:45:00', 'person:list', 1);
INSERT INTO `menu` VALUES (81, b'0', '家谱系统', '', 0, 0, 'role', 'ancestor', b'0', b'0', '', '2019-11-18 23:49:45', '', 0);
INSERT INTO `menu` VALUES (82, b'0', '定居地点', 'ancestor/live/index', 81, 999, 'role', 'live', b'0', b'0', 'Live', '2019-11-18 23:52:43', 'live:list', 1);
INSERT INTO `menu` VALUES (83, b'0', '家谱查看', 'ancestor/display/index', 81, 999, 'dept', 'display', b'0', b'0', '', '2020-05-20 20:09:10', '', 1);
...
-- ----------------------------
INSERT INTO `quartz_log` VALUES (1, 'visitsTask', '2019-11-19 00:00:00', '0 0 0 * * ?', NULL, b'1', '更新访客记录', 'run', NULL, 23);
...
CREATE TABLE `sys_role`  (
  ...
  `UPDATE_DATE` datetime(0) NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
  UNIQUE INDEX `ROLE_SN`(`SN`) USING BTREE
...
CREATE TABLE `sys_user`  (
  ...
  `VERIFY` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户注册验证码',
  ...
  `STATUS` enum('PENDING','ACTIVE','INACTIVE','DELETED') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `sys_user_role`  (
  ...
  INDEX `FK_sys_user_role`(`ROLE_ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, NULL, 'admin@ancestor.net', 1, 'e10adc3949ba59abbe56e057f20f883e', 'admin', 2, '18888888888', 11, '2018-08-23 09:11:56', '2019-05-18 17:34:21');
INSERT INTO `user` VALUES (3, NULL, 'test@ancestor.net', 1, 'e10adc3949ba59abbe56e057f20f883e', 'test', 2, '17777777777', 12, '2018-12-27 20:05:26', '2019-04-01 09:15:24');
...
INSERT INTO `visits` VALUES (111, '2019-11-18 23:17:34', '2019-11-18', 1, 1, 'Mon');
INSERT INTO `visits` VALUES (112, '2019-11-19 00:00:00', '2019-11-19', 2, 2, 'Tue');
INSERT INTO `visits` VALUES (113, '2020-05-17 17:13:02', '2020-05-17', 1, 2, 'Sun');
...
CREATE TABLE `web_page`  (
  ...
  `META_DESCRIPTION` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CONTENT` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `TARGET` set('header','sidebar','footer') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `INSERT_DATE` datetime(0) NOT NULL,
...
CREATE TABLE `web_website`  (
  ...
  `META_KEYWORDS` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `META_DESCRIPTION` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TEMPLATE` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `LAYOUT` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `AREA_HEADER` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `AREA_SIDEBAR` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `AREA_BANNER` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `AREA_FOOTER` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
